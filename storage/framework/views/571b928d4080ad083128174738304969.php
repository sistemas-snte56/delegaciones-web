...
<?php $__env->startSection('content'); ?>
    ...
    <form action=" <?php echo e(route('region.update', $region)); ?> " method="post">
        <div class="card">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','value' => ''.e($region->region).'']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','value' => ''.e($region->sede).'']); ?>
                     <?php $__env->slot('prependSlot', null, []); ?> 
                        <div class="input-group-text">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','value' => ''.e($region->coordinador).'']); ?>
                     <?php $__env->slot('prependSlot', null, []); ?> 
                        <div class="input-group-text">
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Form\Button::resolve(['type' => 'submit','label' => 'Actualizar','theme' => 'warning','icon' => 'fa fa-save'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delegaciones\resources\views/config/regiones/edit.blade.php ENDPATH**/ ?>