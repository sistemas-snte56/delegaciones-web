...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            ...
            <div class="col-5">
                <button type=submit class="btn btn-block <?php echo e(config('adminlte.classes_auth_btn', 'btn-flat btn-warning')); ?>">
...
<?php $__env->startSection('auth_footer'); ?>
    ...
    <?php if(Route::has('password.request')): ?>
        <p class="my-0">
            <a class="text-orange"  href="<?php echo e(route('password.request')); ?>">
    ...
    <?php if($register_url): ?>
        <p class="my-0">
            <a class="text-orange" href="<?php echo e($register_url); ?>">
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\delegaciones\resources\views/vendor/adminlte/auth/login.blade.php ENDPATH**/ ?>